 ...
 */
public class c3_8_FacialInjuryFragment extends Fragment implements ToggleReadVisualInterface, RelatedFirstAidInterface {
    ...
    public boolean[] isFirstAidRelated() {
        boolean isRelated[] = {true, true, false, true, false, false, false, false, false, false, false};
        return isRelated;
    }
}